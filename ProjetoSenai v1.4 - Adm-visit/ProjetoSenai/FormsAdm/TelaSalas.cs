...
{
    public partial class TelaSalas : Form
    {
       ...
       Thread f2;
        ...
        {
            Tela_Cadas_Sala prox = new Tela_Cadas_Sala();
            prox.ShowDialog();
        }
        ...
        private void iconButton1_Click(object sender, EventArgs e)
        {
            MySqlConnection conexao = con.getconexao();
            conexao.Open();
            string sql = "select tb_sala_do_predio.id_sala from tb_sala_do_predio where id_sala = @id_sala";
        ...
        {
            Application.Run(new Tela_att_Sala(id_on));
        }
        ...
        private void iconButton2_Click(object sender, EventArgs e)
        {
            ...
            if(resposta == DialogResult.Yes)
            {
                ...
                conexao.Open();
                string delet = "delete from tb_sala_do_predio where id_sala = '" + box_pesquisa.Text + "'";
        ...
        private void TelaSalas_Load(object sender, EventArgs e)
        {
